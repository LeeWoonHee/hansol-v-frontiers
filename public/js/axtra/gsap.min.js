...
!function( t, e ) {
  ...
  var I, B, l, L, h, n, a, i, o, f, c, d, p, _, m, g, b, k, M, O, C, A, D, E, z, F, Y, N,
    ...
    q = { duration: .5, overwrite: !1, delay: 0 }, U = 1e8, V = 1 / U, W = 2 * Math.PI, X = W / 4, H = 0, K = Math.sqrt,
    Z = Math.cos, G = Math.sin, J = "function" == typeof ArrayBuffer && ArrayBuffer.isView || function() {
  ...
  var Vt, Wt, Xt = function _addPropTween( t, e, i, n, a, o, u, h, l, f ) {
    ...
    var i, n, a, s, o, u, h, l, f, c, d, p, _, m = t.vars, g = m.ease, v = m.startAt, y = m.immediateRender, T = m.lazy,
      b = m.onUpdate, x = m.onUpdateParams, k = m.callbackScope, M = m.runBackwards, O = m.yoyoEase, P = m.keyframes,
      C = m.autoRevert, A = t._dur, S = t._startAt, R = t._targets, D = t.parent,
  ...
  var Gt = function( z ) {
    function Tween( e, r, i, n ) {
      ...
      var s, o, u, h, l, f, c, d, p = ( a = z.call( this, n ? r : va( r ) ) || this ).vars, _ = p.duration, m = p.delay,
        g = p.immediateRender, T = p.stagger, b = p.overwrite, x = p.keyframes, k = p.defaults, M = p.scrollTrigger,
        O = p.yoyoEase, P = r.parent || L, C = ( $( e ) || J( e ) ? t( e[ 0 ] ) : "length" in r ) ? [ e ] : Ot( e );
    ...
    return e.render = function render( t, e, r ) {
      ...
      if( p ) {
        ...
        var n, a, s, o = t.ratio, u = e < 0 || !e && ( !t._start && function _parentPlayheadIsBeforeStart( t ) {
          ...
          }( t ) && ( t._initted || !bt( t ) ) || ( t._ts < 0 || t._dp._ts < 0 ) && !bt( t ) ) ? 0 : 1, h = t._rDelay,
          l = 0;
  ...
  var Ae, Se, Re, De, Ee, ze, Fe, Ie, Be = Ft.Power0, Le = Ft.Power1, Ye = Ft.Power2, Ne = Ft.Power3, qe = Ft.Power4,
    ...
    fr = lr + "Origin", cr = "O,Moz,ms,Ms,Webkit".split( "," ), dr = function _checkPropPrefix( t, e, r ) {
      ...
      var r, i, n, a, s, o = e || this, u = o.xPercent, h = o.yPercent, l = o.x, f = o.y, c = o.rotation, d = o.skewX,
        ...
        w = o.forceCSS, x = parseFloat( l ), k = parseFloat( f );
